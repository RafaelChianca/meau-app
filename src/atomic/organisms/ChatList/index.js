            ...
            <Card onPress={openChat}>
                <Group style={{flexDirection: 'row', borderColor:'#bdbdbd', borderBottomWidth:1, marginTop:20}}>
                    ...
                    <Group style={{flexDirection: 'column'}}>
                        <InputLabel style={{color: '#589b9b', fontSize: 12}}>Nome da pessoa | Nome do animal</InputLabel>
                        <InfoText style={{color: '#757575', fontSize: 14}} numberOfLines={1}>blablablaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</InfoText>
                    </Group>
